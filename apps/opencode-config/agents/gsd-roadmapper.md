...
Reference full template: `/home/val/.config/opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/val/.config/opencode/get-shit-done/templates/state.md`.
