...
```markdown
Read /home/val/.config/opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/val/.config/opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/val/.config/opencode/agents/gsd-ui-checker.md for instructions.
