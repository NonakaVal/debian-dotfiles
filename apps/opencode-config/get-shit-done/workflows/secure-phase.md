...
```
Agent(
  prompt="Read /home/val/.config/opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/val/.config/opencode/get-shit-done/templates/SECURITY.md`
