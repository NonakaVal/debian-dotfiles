...
```bash
INIT=$(node "/home/val/.config/opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/val/.config/opencode/get-shit-done/bin/gsd-tools.cjs" commit \
