...
<required_reading>
@/home/val/.config/opencode/get-shit-done/references/user-story-template.md
@/home/val/.config/opencode/get-shit-done/references/spidr-splitting.md
@/home/val/.config/opencode/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/val/.config/opencode/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/val/.config/opencode/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/val/.config/opencode/get-shit-done/references/spidr-splitting.md`. Briefly:
